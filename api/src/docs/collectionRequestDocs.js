...
module.exports = {
  ...
  "/collection-requests/analytics": { get: { summary: "Get user's garbage collection analytics", description: "Retrieves daily garbage production analytics for chart visualization. Always returns exactly 7 days of data (today + previous 6 days). Days with no data will show value 0.", tags: ["Collection Requests"], security: [{ bearerAuth: [] }], responses: { "200": { description: "Analytics data retrieved successfully", content: { "application/json": { schema: { type: "object", properties: { success: { type: "boolean", example: true }, message: { type: "string", example: "Collection analytics retrieved successfully" }, data: { type: "array", minItems: 7, maxItems: 7, items: { type: "object", properties: { date: { type: "string", example: "19th Feb" }, value: { type: "number", example: 1400 } } } } } } } } }, "401": { description: "Unauthorized" }, "403": { description: "Forbidden - Insufficient permissions" } } } },
